...
// TODO(etp-12-migration): This entire map uses the OLD 17-spectrum IDs and must be rebuilt for 12-spectrum model.
...
//	7→voltage_sensitivity (keep, ID 3)   8→impulse_gap (removed, now executive_function accelerator skill)
...
//
// New map should be keyed 1-12 with entries for: social_gravity, energy_directionality,
// voltage_sensitivity, threat_response, care_response, risk_tolerance, integrity_logic,
// mirror_neuron_tuning, orderliness, responsibility_threshold, loss_sensitivity, libido
...
// ETPProfile represents a student's full ETP profile (12 spectra)
