...
# Generates a comprehensive, shareable overview of the ESP/HumanOS ecosystem
#
# Usage: ./generate-project-index.sh [output_file]
#
# Output: A single markdown file suitable for:
#   - Sharing with potential employers/collaborators
#   - Feeding to AI assistants
#   - Self-reference during development
...
# Project roots
ASSIST="/Users/michaelstewart/Coding/assist"
LAOMOBILE="/Users/michaelstewart/Coding/LAOMobile"
SKILLSMARKBOOK="/Users/michaelstewart/Coding/SkillsMarkbookMobile"
DRB="/Users/michaelstewart/Coding/DRB"
HUMANOS="/Users/michaelstewart/Coding/humanOS"
ESPPROJ="/Users/michaelstewart/Coding/ESPProj"
SKILLSMAP="/Users/michaelstewart/Coding/skills-map-platform"
...
# Function to get status from README
get_status() {
    local readme="$1/README.md"
    if [ -f "$readme" ]; then
        grep -i "status" "$readme" | head -1 | sed 's/.*: *//' || echo "Active"
    else
        echo "Unknown"
    fi
}
...
# Add project rows
echo "| **SkillsMarkbookMobile** | Primary teacher competency logging | Development | React Native, Expo |" >> "$OUTPUT_FILE"
echo "| **DRB** | Trust financial & estates monitoring | Development | Go, PostgreSQL, Open Banking |" >> "$OUTPUT_FILE"
echo "| **LAOMobile** | GCSE revision app | TestFlight | React Native, Go, MongoDB |" >> "$OUTPUT_FILE"
echo "| **assist** | Monorepo (docs, API, frontend) | Active | Go, React, Weaviate, Docker |" >> "$OUTPUT_FILE"
echo "| **skills-map-platform** | Skills tree, course maps, student proficiency | Active | Go, React, MySQL, Weaviate |" >> "$OUTPUT_FILE"
echo "| **ESPProj** | Legacy MIS features | Migration | Go, React, MySQL |" >> "$OUTPUT_FILE"
echo "| **humanOS** | Emotional motivation models | Research | Documentation, Weaviate |" >> "$OUTPUT_FILE"
