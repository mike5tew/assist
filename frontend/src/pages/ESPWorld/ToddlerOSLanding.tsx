...
const parentSpectra = [
  ...
  },
  {
    ...
    left: 'Deflecting',
    right: 'Absorbing',
    description: 'When something goes wrong, does your child deflect blame or absorb all of it?',
    color: '#37474f',
    ageHint: 'Observable from ~3 years',
    question: 'When something breaks, does your child say "it wasn\'t me" or "it\'s all my fault"?',
  },
  {
    name: 'Loss Sensitivity',
    left: 'Detached',
    right: 'Territorial',
    description: 'How does your child react when something is taken away or lost?',
    color: '#4e342e',
    ageHint: 'Observable from ~2 years',
  ...
  },
  {
    ...
    left: 'Restrained',
    right: 'Expressive',
    description: 'How much drive energy does your child express outwardly? (Physical desire to grab, touch, want.)',
    color: '#880e4f',
    ageHint: 'Observable from ~3 years',
    question: 'Does your child hold back when they want something, or reach for it immediately?',
  },
];
...
// ─── Component ──────────────────────────────────────────────
const ToddlerOSLanding: React.FC = () => {
  ...
  return (
    <Box>
      <SEO
        title="ToddlerOS — The Coding Lesson You Never Knew You Needed"
        description="ToddlerOS helps parents of young children understand their child's biological wiring across the 12 ETP spectra. See behaviour as communication, not defiance."
        path="/toddler-os"
      />
      {/* ── Hero Section ── */}
      <Box
            ...
            <Grid item xs={12} md={7}>
              ...
              <Stack spacing={3}>
                ...
                <Typography variant="h5" sx={{ opacity: 0.92, maxWidth: 620 }}>
                  Your toddler runs on biological code — 12 spectra that shape every tantrum, 
                  every giggle, every refusal. ToddlerOS helps you read the source code 
                  so you can work with their wiring, not against it.
                </Typography>

                <Stack direction="row" spacing={1.5} flexWrap="wrap" useFlexGap>
                  <Chip label="12 Biological Spectra" sx={{ bgcolor: 'rgba(255,255,255,0.15)', color: 'white' }} />
                  <Chip label="Ages 2–7" sx={{ bgcolor: 'rgba(255,255,255,0.15)', color: 'white' }} />
            ...
            <Grid item xs={12} md={5}>
              ...
              >
                ...
                <Typography variant="body2" color="text.secondary" paragraph>
                  <strong>ToddlerOS is not a diagnostic tool.</strong> It is a lens — one of many. 
                ...
                <Typography variant="body2" sx={{ mt: 2, fontStyle: 'italic', color: 'text.secondary' }}>
                  "If you have genuine concerns about your child's development, speak to a health visitor, GP, or specialist teacher. ToddlerOS complements professional judgment — it doesn't replace it."
                </Typography>
              </Paper>
            </Grid>
          </Grid>
      ...
      <Box sx={{ py: { xs: 6, md: 8 }, bgcolor: '#f5f7f9' }}>
        <Container maxWidth={false} sx={{ maxWidth: '1400px' }}>
          ...
          >
            Most parenting advice tells you what to <em>do</em>. ToddlerOS helps you understand 
          ...
          <Grid container spacing={3}>
            {[
              ...
              },
              {
                ...
                description: 'Your child has one nervous system. It doesn\'t switch off at the school gate. ToddlerOS gives you a common language with teachers — so home and school can work together, not in parallel.',
              },
              {
                icon: <SelfIcon fontSize="large" />,
                title: 'Your Wiring Matters Too',
                description: 'ToddlerOS will include tools for parents to understand their own spectra. Compatibility friction happens when your settings clash with your child\'s — and that\'s nobody\'s fault.',
              },
              {
                icon: <SchoolIcon fontSize="large" />,
                title: 'From PrimaryOS to ToddlerOS',
                description: 'The same ETP framework used in classrooms is being developed for families. Your child\'s teacher may already be observing the same patterns — ToddlerOS will help you see what they see.',
              },
            ].map((card) => (
      ...
      <Box sx={{ py: { xs: 6, md: 8 } }}>
        <Container maxWidth={false} sx={{ maxWidth: '1400px' }}>
          ...
          >
            Every child is born with these twelve sliders. Their positions are not flaws — they're 
          ...
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="body1" sx={{ fontSize: '1.1rem', lineHeight: 1.7, mb: 3 }}>
                ...
                challenge. ToddlerOS helps you identify where your settings clash, so you can design 
      ...
      <Box sx={{ py: { xs: 6, md: 8 } }}>
        <Container maxWidth={false} sx={{ maxWidth: '1400px' }}>
          ...
          >
            ...
            ToddlerOS connects to PrimaryOS, creating a shared language between home and school.
          </Typography>
                ...
                {[
                  {
                    ...
                    description: 'Your child\'s teacher may already be observing ETP patterns in the classroom. ToddlerOS gives you access to the same framework.',
                  },
                  {
                    icon: <ConnectIcon />,
        ...
        <Container maxWidth="md">
          ...
          >
            ...
            <Typography variant="body1" sx={{ mb: 3, maxWidth: 550, mx: 'auto' }}>
              Every parent deserves to understand their child's wiring. The core ToddlerOS framework — 
            ...
            <Typography variant="body2" color="text.secondary">
              ...
              ToddlerOS exists to serve families — not to profit from them.
            </Typography>
          </Paper>
        </Container>
      </Box>
        ...
        <Container maxWidth={false} sx={{ maxWidth: '1400px' }}>
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="body1" paragraph sx={{ fontSize: '1.1rem', lineHeight: 1.7 }}>
                ToddlerOS wasn't designed in a Silicon Valley boardroom. It was forged in 12 years 
              ...
              <Typography variant="body1" sx={{ fontSize: '1.1rem', lineHeight: 1.7 }}>
                ToddlerOS brings those 12 years of pattern recognition to your family — not as 
      ...
      {/* ── What ToddlerOS Is Not ── */}
      <Box sx={{ py: { xs: 6, md: 8 }, bgcolor: '#f5f7f9' }}>
        <Container maxWidth={false} sx={{ maxWidth: '1400px' }}>
          <Typography variant="h4" component="h2" textAlign="center" fontWeight="bold" gutterBottom>
            What ToddlerOS Is — And Isn't
          </Typography>
      ...
      >
        <Container maxWidth="md">
          ...
          <Typography variant="body1" sx={{ mb: 4, maxWidth: 600, mx: 'auto', opacity: 0.95 }}>
            ToddlerOS gives you a framework for seeing what's already there. 
          ...
          <Typography variant="caption" sx={{ display: 'block', mt: 4, opacity: 0.8 }}>
            ToddlerOS is in development. Register your interest to be notified when it launches.
          </Typography>
        </Container>
      </Box>
      ...
      <Box sx={{ py: 3, textAlign: 'center', bgcolor: '#0f766e', color: 'rgba(255,255,255,0.8)' }}>
        <Typography variant="body2">
          ToddlerOS — The Foundational Code Your Family Runs On — Part of the ESP Thinking Portfolio
        </Typography>
        <Typography variant="caption" sx={{ display: 'block', mt: 0.5, opacity: 0.7 }}>
          ToddlerOS is an observational framework, not a medical device. Always consult qualified professionals for developmental concerns.
        </Typography>
      </Box>
    </Box>
  );
...
export default ToddlerOSLanding;